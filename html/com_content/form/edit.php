...
<td class="col2"><fieldset>
<span class="formelm-buttons">
<button type="button" onclick="Joomla.submitbutton('article.cancel')">
<?php echo JText::_('JCANCEL') ?>
</button>
<button type="button" onclick="Joomla.submitbutton('article.save')" class="bigbutton">
<?php echo JText::_('JSAVE') ?>
</button>
</span>
</fieldset></td>
</tr>
<tr class="table-part2">
<td class="col1"><fieldset>
...
<td class="col2"><fieldset>
<legend><?php echo JText::_('COM_CONTENT_PUBLISHING2'); ?></legend>
<div class="formelm">
...
<td class="col3"><fieldset>
<legend><?php echo JText::_('COM_CONTENT_PUBLISHING3'); ?></legend>
<div class="formelm">
...
<table class="table-edit metadata" style="margin-top:50px;">
<tr><td>
<fieldset>
...
<table class="table-edit imageslink" style="margin-top:20px;">
<tr><td colspan="1">
<fieldset>
