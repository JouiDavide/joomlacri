...
<!-- SPOSTATO IN FONDO PER MODULO VOTAZIONE <?php echo $this->item->event->beforeDisplayContent; ?> -->
...
<!-- "DETTAGLI" <dt class="article-info-term"><?php  echo JText::_('COM_CONTENT_ARTICLE_INFO'); ?></dt> -->
<?php endif; ?>
...
<?php endif; ?>
<div><?php echo $this->item->event->beforeDisplayContent; ?></div>
</div>
