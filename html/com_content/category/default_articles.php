...
<table class="table-edit table-filters">
<tr><td>
<fieldset class="filters">
<?php if ($this->params->get('filter_field') != 'hide') :?>
<!--//label hidden <legend class="hidelabeltxt"><?php echo JText::_('JGLOBAL_FILTER_LABEL'); ?></legend>-->
...
<td>
<fieldset class="filters">
<!--//label hidden <legend class="hidelabeltxt"><?php echo JText::_('JGLOBAL_FILTER_LABEL2'); ?></legend> -->
...
<?php // -CRI is added to override  output ?>
<?php echo JHtml::_('grid.sort', 'JAUTHOR-CRI', 'author', $listDirn, $listOrder); ?>
</th>
<?php endif; ?>
